...
namespace Cfg.Test {
    ...
    public class AttributeBased {
        ...
        public void TestEmptyCfg() {
            var root = new AttributeCfg().Load(new NanoXmlDocument(@"<cfg></cfg>").RootNode);
        ...
        public void TestEmptySites() {
            var node = new AttributeCfg().Load(new NanoXmlDocument(@"<cfg><sites/></cfg>").RootNode);
        ...
        public void TestInvalidProcess() {
            var node = new AttributeCfg().Load(new NanoXmlDocument(
                @"<cfg>
                    <sites>
                        <add/>
                    </sites>
