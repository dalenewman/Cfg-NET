...
REM nuget.exe push "c:\temp\modules\Cfg-NET.0.13.3-beta.nupkg" -source https://api.nuget.org/v3/index.json
REM nuget.exe push "c:\temp\modules\Cfg-NET.Reader.0.13.3-beta.nupkg" -source https://api.nuget.org/v3/index.json
