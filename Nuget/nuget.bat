...
nuget.exe push "c:\temp\modules\Cfg-NET.0.10.4.nupkg" -source https://api.nuget.org/v3/index.json
REM nuget.exe push "c:\temp\modules\Cfg-NET.Reader.0.3.3.nupkg" -source https://api.nuget.org/v3/index.json
REM nuget.exe push "c:\temp\modules\Cfg-NET.Environment.0.3.2.nupkg" -source https://api.nuget.org/v3/index.json
