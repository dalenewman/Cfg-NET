...
namespace Cfg.Demo.Cfg {
    ...
    public class TflTransform : CfgNode {
        ...
        public TflTransform() {
            ...
            Property(name: "message-field", value: "[default]");
            ...
            Property(name: "result-field", value: "[default]");
            ...
            Property(name: "run-value", value: "[default]");
            Property(name: "script", value: string.Empty);
            Property(name: "separator", value: "[default]");
